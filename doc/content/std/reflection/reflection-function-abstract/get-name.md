---
kind: method
id: std.reflection.ReflectionFunctionAbstract::getName
title: ReflectionFunctionAbstract::getName
summary: Returns the canonical callable name.
name: getName
order: 38
typeParameters: []
parameters: []
returns:
  type: string
  description: Returns the canonical callable name.
errors: []
related:
...
Returns the canonical callable name.
