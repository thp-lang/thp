---
kind: method
id: std.spl.SplPriorityQueue::insert
...
parameters:
  ...
  - name: priority
    type: P
    description: Priority used to order the value.
returns:
  type: "true"
...
[`SplPriorityQueue`](thp:std.spl.SplPriorityQueue)`::insert()` adds a value to the container.
...
```thp
$result = $instance->insert($value, $priority);
```
