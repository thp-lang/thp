---
kind: method
id: std.spl.SplFileInfo::getExtension
title: SplFileInfo::getExtension
summary: Returns the filename extension without the dot.
name: getExtension
order: 4
typeParameters: []
parameters: []
returns:
  type: string
  description: Returns the filename extension without the dot.
errors:
  - description:
...
[`SplFileInfo`](thp:std.spl.SplFileInfo)`::getExtension()` returns the filename extension without the dot.
