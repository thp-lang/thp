---
kind: method
id: std.spl.SplFileInfo::isFile
title: SplFileInfo::isFile
summary: Reports whether the path is a regular file.
name: isFile
order: 19
typeParameters: []
parameters: []
returns:
  type: bool
  description: Reports whether the path is a regular file.
errors:
  - description:
...
[`SplFileInfo`](thp:std.spl.SplFileInfo)`::isFile()` reports whether the path is a regular file.
