---
kind: method
id: std.spl.SplFileInfo::getPathname
title: SplFileInfo::getPathname
summary: Returns the original pathname.
name: getPathname
order: 6
typeParameters: []
parameters: []
returns:
  type: string
  description: Returns the original pathname.
errors:
  - description:
...
[`SplFileInfo`](thp:std.spl.SplFileInfo)`::getPathname()` returns the original pathname.
