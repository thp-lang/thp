---
kind: method
id: std.async.Coroutine::isCompleted
title: Coroutine::isCompleted
...
[`Coroutine`](thp:std.async.Coroutine)`::isCompleted()` returns true after successful, failed, or cancelled completion.
