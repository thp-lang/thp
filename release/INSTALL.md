...
```sh
THP_ARCHIVE=thp-0.3.0-linux-x86_64.tar.gz
...
```sh
THP_ARCHIVE=thp-0.3.0-macos-x86_64.tar.gz
...
```sh
THP_ARCHIVE=thp-0.3.0-macos-arm64.tar.gz
...
```powershell
$ThpArchive = "thp-0.3.0-windows-x86_64.zip"
...
THP v0.3.0 is not production-ready, is not a PHP-compatible replacement, and
